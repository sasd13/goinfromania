...
public class DimensionConstants {
	...
	public static final int PANEL_WIDTH_LARGE = 640;
	
	public static final int PANEL_HEIGHT_SMALL = 240;
	public static final int PANEL_HEIGHT_MEDIUM = 320;
	public static final int PANEL_HEIGHT_LARGE = 480;
